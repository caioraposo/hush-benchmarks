...
plot(f1$n, f1$time, main = "Lines benchmark", xlab = "Number of Objects", ylab = "Time (seconds)", type = "l", frame = FALSE, col = "blue")
...
legend(0, 5.0, legend=c("Original", "Unsafe memoization", "Guarded memoization", "Alias set", "Ownership pointers"), pch=c(19, 19, 19, 19, 19), col=c("blue", "red", "green", "black", "orange"))
...
legend(50, 40, legend=c("Original", "Unsafe memoization", "Guarded memoization", "Alias set", "Ownership pointers"), pch=c(19, 19, 19, 19, 19), col=c("blue", "red", "green", "black", "orange"))
