...
legend(0, 8, legend=c("Original", "Unsafe memoization", "Guarded memoization", "Alias set"), pch=c(19, 19, 19, 19), col=c("blue", "red", "green", "black"))

plot(f1$n, f1$memory / 1000, main = "Memory usage", xlab = "Number of Objects", ylab = "Memory (Mbytes)", type = "l", frame = FALSE, col = "blue", ylim = c(0, 200))
...
legend(50, 500, legend=c("Original", "Unsafe memoization", "Guarded memoization", "Alias set"), pch=c(19, 19, 19, 19), col=c("blue", "red", "green", "black"))
