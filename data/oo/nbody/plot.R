...
f6 <- read.csv(file = "csv/ownership-pointers.csv")

plot(f1$n, f1$time, main = "Nbody benchmark", xlab = "Number of Objects", ylab = "Time (seconds)", type = "l", frame = FALSE, col = "blue")
...
legend(0, 10, legend=c("Original", "Unsafe memoization", "Alias set", "Optimized alias set"), pch=c(19, 19, 19, 19, 19), col=c("blue", "red", "black", "orange"))
...
legend(50, 100, legend=c("Original", "Unsafe memoization", "Alias set", "Optimized alias set"), pch=c(19, 19, 19, 19, 19), col=c("blue", "red", "black", "orange"))
