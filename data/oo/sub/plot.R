...
plot(f1$n, f1$time, main = "Submarine benchmark", xlab = "Number of Objects", ylab = "Time (seconds)", type = "l", frame = FALSE, col = "blue", ylim = c(0, 0.6))
...
plot(f1$n, f5$collisions / f1$n * 1 / 2, main = "Collision ratio x Input size", xlab = "Number of Objects", ylab = "Collision ratio", type = "l", frame = FALSE, col = "blue")
